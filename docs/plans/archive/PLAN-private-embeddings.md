...
> **MOVED:** Canonical version of this plan is now in the turboquant-vectors repo:
> `github.com/back2matching/turboquant-vectors/docs/plans/PLAN-private-embeddings.md`
> This copy is kept for FlockRun cross-reference only.

**Status:** ALL 8 PHASES COMPLETE. Published as 0.3.0 on PyPI.
**Repo:** github.com/back2matching/turboquant-vectors
